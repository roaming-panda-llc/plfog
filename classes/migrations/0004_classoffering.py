    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "member_discount_pct",
                    models.PositiveIntegerField(default=10, help_text="Auto-applied for verified members."),
                ),
                ("capacity", models.PositiveIntegerField(default=6, help_text="Maximum confirmed registrants.")),
                (
                    "scheduling_model",
                    models.CharField(
                        choices=[("fixed", "Fixed sessions"), ("flexible", "Flexible (arrange with instructor)")],
                        default="fixed",
                ...
                (
                    "is_private",
                    models.BooleanField(
                        default=False, help_text="Hidden from public portal; private registration only."
                    ),
                ),
                (
                    "private_for_name",
                    models.CharField(blank=True, help_text="Name shown when private.", max_length=255),
                ),
                (
                    "recurring_pattern",
                    models.CharField(blank=True, help_text="Free-text recurrence description.", max_length=255),
                ),
                ("image", models.ImageField(blank=True, help_text="Hero image.", upload_to="classes/images/")),
                (
                    "requires_model_release",
                    models.BooleanField(default=False, help_text="When on, registrants also sign model release."),
                ),
                (
                    "status",
                    models.CharField(
