    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="guild_votes_received", to="membership.guild"
            ),
        ),
        migrations.AlterField(
            model_name="guildvote",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("session", "member_airtable_id", "priority"), name="unique_session_member_priority"
            ),
        ),
        migrations.AddConstraint(
            model_name="guildvote",
            constraint=models.UniqueConstraint(
                fields=("session", "member_airtable_id", "guild"), name="unique_session_member_guild"
            ),
        ),
    ]
